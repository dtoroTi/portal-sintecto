...
if ($backgroundCheck->getVerificationSection(VerificationSectionType::DETAIL_COMPANY_FINANTIAL_ANALYS)->percentCompleted >=100 ) {
    ...
    $pdf->MultiCell(45, 0, number_format($leverage_0, 2, '.', ''). " veces\n" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($leverage_1, 2, '.', ''). " veces\n" , 1, 'R', 1, 1, '', '', true);
    ...
    $pdf->MultiCell(45, 0, number_format($margenBruto_0, 2, '.', ''). " veces\n" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($margenBruto_1, 2, '.', ''). " veces\n" , 1, 'R', 1, 1, '', '', true);
