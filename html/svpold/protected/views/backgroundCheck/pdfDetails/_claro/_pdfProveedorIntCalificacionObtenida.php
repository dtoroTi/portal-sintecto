<?php
    ...
    $wCol1 = 100; $wCol2 = 25; $wCol3 = 25; $wCol4 = 20; $wCol5 = 150;
    ...
    $pdf->MultiCell( $wCol2 , 5, "OBTENIDO" , 1, 'C', 1, 0, '', '', true);
    ...
    $pdf->MultiCell( $wCol1 , 0, "1. ACTIVIDAD" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol2 , 0, $points_1 . "%" , 1, 'C', 1, 0, '', '', true);
    ...
    $pdf->MultiCell( $wCol2 , 0, $Obt_1_1 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 0, $Max_1_1 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 0, valCalc( "peso", $Obt_1_1, $Max_1_1 , $val_1 , $weight_1 ) , 1, 'C', 0, 1, '', '', true);

    $pdf->SetFont('Arial', '', 6); $pdf->SetFillColor(0,66,109); $pdf->SetTextColor(255);
    $pdf->MultiCell( $wCol1 , 0, "2. TAMAÑO" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol2 , 0, $points_2 . "%" , 1, 'C', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 0, $val_2 . "%" , 1, 'C', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 0, pondCalc("peso", $points_2 , $val_2, $weight_2) , 1, 'C', 1, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1 , 0, "2.1 Tamaño de la Empresa según Ventas Anuales" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 0, $Obt_2_1 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 0, $Max_2_1 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 0, valCalc( "peso", $Obt_2_1, $Max_2_1 , $val_2 , $weight_2 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1 , 0, "2.2 Tamaño de la Empresa según Personal Ocupado" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 0, $Obt_2_2 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 0, $Max_2_2 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 0, valCalc( "peso", $Obt_2_2, $Max_2_2 , $val_2 , $weight_2 ) , 1, 'C', 0, 1, '', '', true);

    $pdf->SetFont('Arial', '', 6); $pdf->SetFillColor(0,66,109); $pdf->SetTextColor(255);
    $pdf->MultiCell( $wCol1 , 0, "3. SISTEMA DE GESTIÓN DE CALIDAD" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol2 , 0, $points_3 . "%" , 1, 'C', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 0, $val_3 . "%" , 1, 'C', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 0, pondCalc("peso", $points_3 , $val_3, $weight_3) , 1, 'C', 1, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1 , 0, "3.1 Certificación ISO 9001" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 0, $Obt_3_1 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 0, $Max_3_1 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 0, valCalc( "peso", $Obt_3_1, $Max_3_1 , $val_3 , $weight_3 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1 , 0, "3.2 Certificación ISO 14001" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 0, $Obt_3_2 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 0, $Max_3_2 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 0, valCalc( "peso", $Obt_3_2, $Max_3_2 , $val_3 , $weight_3 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1 , 0, "3.3 Certificación ISO 18001" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 0, $Obt_3_3 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 0, $Max_3_3 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 0, valCalc( "peso", $Obt_3_3, $Max_3_3 , $val_3 , $weight_3 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1 , 0, "3.4 Certificación ISO 27001" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 0, $Obt_3_4 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 0, $Max_3_4 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 0, valCalc( "peso", $Obt_3_4, $Max_3_4 , $val_3 , $weight_3 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1 , 0, "3.5 Certificación ISO 28000" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 0, $Obt_3_5 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 0, $Max_3_5 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 0, valCalc( "peso", $Obt_3_5, $Max_3_5 , $val_3 , $weight_3 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1 , 0, "3.6 Certificación OEA" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 0, $Obt_3_6 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 0, $Max_3_6 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 0, valCalc( "peso", $Obt_3_6, $Max_3_6 , $val_3 , $weight_3 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1 , 0, "3.7 Certificación en Responsabilidad Social, Sostenibilidad, Medio Ambiente" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 0, $Obt_3_7 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 0, $Max_3_7 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 0, valCalc( "peso", $Obt_3_7, $Max_3_7 , $val_3 , $weight_3 ) , 1, 'C', 0, 1, '', '', true);


    $pdf->SetFont('Arial', '', 6); $pdf->SetFillColor(0,66,109); $pdf->SetTextColor(255);
    $pdf->MultiCell( $wCol1 , 0, "4. COMERCIO INTERNACIONAL" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol2 , 0, $points_4 . "%" , 1, 'C', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 0, $val_4 . "%" , 1, 'C', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 0, pondCalc("peso", $points_4 , $val_4, $weight_4) , 1, 'C', 1, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1 , 0, "4.1 Antigüedad del soporte de experiencia enviado para uno de los productos/servicios de la actividad principal a nivel internacional" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 0, $Obt_4_1 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 0, $Max_4_1 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 0, valCalc( "peso", $Obt_4_1, $Max_4_1 , $val_4 , $weight_4 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1 , 0, "4.2 Cobertura Internacional para la venta de sus productos o suministro de sus servicios" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 0, $Obt_4_2 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 0, $Max_4_2 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 0, valCalc( "peso", $Obt_4_2, $Max_4_2 , $val_4 , $weight_4 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1 , 0, "4.3 Representación (sucursales, filiales, sedes) en países distintos al de origen" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 0, $Obt_4_3 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 0, $Max_4_3 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 0, valCalc( "peso", $Obt_4_3, $Max_4_3 , $val_4 , $weight_4 ) , 1, 'C', 0, 1, '', '', true);


    $pdf->SetFillColor(0,66,109); $pdf->SetTextColor(255);
    $pdf->MultiCell( $wCol1, 5, "5. INFORMACIÓN FINANCIERA" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol2 , 5, $points_6 . "%" , 1, 'C', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $val_6 . "%" , 1, 'C', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, pondCalc("peso", $points_6 , $val_6, $weight_6) , 1, 'C', 1, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "5.1 Capital de Trabajo" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_6_1 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_6_1 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_6_1, $Max_6_1 , $val_6 , $weight_6 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "5.2 Razón Corriente" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_6_2 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_6_2 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_6_2, $Max_6_2 , $val_6 , $weight_6 ) , 1, 'C', 0, 1, '', '', true);

    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "5.3 Nivel de Endeudamiento" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_6_3 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_6_3 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_6_3, $Max_6_3 , $val_6 , $weight_6 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "5.4 Concentración de Endeudamiento CP" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_6_4 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_6_4 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_6_4, $Max_6_4 , $val_6 , $weight_6 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "5.5 Endeudamiento/Ventas" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_6_5 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_6_5 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_6_5, $Max_6_5 , $val_6 , $weight_6 ) , 1, 'C', 0, 1, '', '', true);

    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "5.6 Endeudamiento Financiero" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_6_6 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_6_6 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_6_6, $Max_6_6 , $val_6 , $weight_6 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "5.7 Margen EBITDA" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_6_7 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_6_7 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_6_7, $Max_6_7 , $val_6 , $weight_6 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "5.8 Rentabilidad Operativa Activo (ROA)" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_6_8 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_6_8 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_6_8, $Max_6_8 , $val_6 , $weight_6 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "5.9 Cobertura de Gastos No Oper." , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_6_9 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_6_9 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_6_9, $Max_6_9 , $val_6 , $weight_6 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "5.10 Utilidades Acumuladas" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_6_10 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "5.11 Ventas Vs. Resultado Neto" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_6_11 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "5.12 Capital de trabajo reducido por debajo del 50%" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_6_12 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(0,66,109); $pdf->SetTextColor(255);
    $pdf->MultiCell( $wCol1, 5, "6. INFORMACIÓN LABORAL" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol2 , 5, $points_5 . "%" , 1, 'C', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $val_5 . "%" , 1, 'C', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, pondCalc("peso", $points_5 , $val_5, $weight_5) , 1, 'C', 1, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "6.1 Sistema de Gestión de Seguridad y salud Ocupacional (SGSSO) implementado" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_5_1 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_5_1 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_5_1, $Max_5_1 , $val_5 , $weight_5 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "6.2. Presentó accidentes fatales o graves en el último año" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_5_2 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_5_2 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_5_2, $Max_5_2 , $val_5 , $weight_5 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "6.3 Política de inclusión y contratación de personas discapacitadas" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_5_3 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_5_3 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_5_3, $Max_5_3 , $val_5 , $weight_5 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "6.4. Realiza acciones que estudien el nivel de satisfacción de los empleados durante el desempeño de sus funciones" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_5_4 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_5_4 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_5_4, $Max_5_4 , $val_5 , $weight_5 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "6.5. Cumple con obligaciones laborales de acuerdo a la reglamentación de países donde opera" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_5_5 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_5_5 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_5_5, $Max_5_5 , $val_5 , $weight_5 ) , 1, 'C', 0, 1, '', '', true);


    $pdf->SetFillColor(0,66,109); $pdf->SetTextColor(255);
    $pdf->MultiCell( $wCol1, 5, "7. CONFIANZA EN EL SERVICIO" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol2 , 5, $points_7 . "%" , 1, 'C', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $val_7 . "%" , 1, 'C', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, pondCalc("peso", $points_7 , $val_7, $weight_7) , 1, 'C', 1, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "7.1 Cuenta con polizas de seguros generales" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_1 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_7_1 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_7_1, $Max_7_1 , $val_7 , $weight_7 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "7.2 Ofrece garantías en productos y/o servicios" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_2 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_7_2 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_7_2, $Max_7_2 , $val_7 , $weight_7 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "7.2 Ofrece servicio de mantenimiento técnico" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_3 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(0,66,109); $pdf->SetTextColor(255);
    $pdf->MultiCell( $wCol1, 5, "8. REFERENCIAS COMERCIALES DE CLIENTES" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol2 , 5, $points_8 . "%" , 1, 'C', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $val_8 . "%" , 1, 'C', 1, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, pondCalc("peso", $points_8 , $val_8, $weight_8) , 1, 'C', 1, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "8.1 Cumplimiento en la entrega de los productos, bienes o servicios" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_1 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_8_1 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_8_1, $Max_8_1 , $val_8 , $weight_8 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "8.2 Calidad del los bienes, productos y/o Servicios" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_2 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_8_2 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_8_2, $Max_8_2 , $val_8 , $weight_8 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "8.3 Servicio al Cliente" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_3 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_8_3 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_8_3, $Max_8_3 , $val_8 , $weight_8 ) , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "8.4 Precio del los productos, bienes o servicios frente a la competencia" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_4 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    */
    ...
    $pdf->MultiCell( $wCol2 , 5, $points_3 . "%" , 1, 'C', 1, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_3_1 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_3_2 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_3_3 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_3_4 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_3_5 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_3_6 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_3_7 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_3_8 , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->MultiCell( $wCol2 , 5, $points_4 . "%" , 1, 'C', 1, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_4_1 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_4_2 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_4_3 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_4_4 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_4 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_5 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_6 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_7 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_8 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_9 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_10 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_11 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_12 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_13 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_14 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, '7.15 Estructura de gestión humana e indicares de gestión' , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_15 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_16 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_17 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_18 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_19 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_20 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_7_21 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(220); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol1, 5, "2. SGSST publicado y comunicado al personal" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_2 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol3 , 5, $Max_8_2 . "%" , 1, 'C', 0, 0, '', '', true);
    $pdf->MultiCell( $wCol4 , 5, valCalc( "peso", $Obt_8_2, $Max_8_2 , $val_8 , $weight_8 ) , 1, 'C', 0, 1, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_5 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_6 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_7 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_8 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_9 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_10 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
$pdf->MultiCell( $wCol2 , 5, $Obt_8_11 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_12 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_13 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_14 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_15 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_16 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_17 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_18 . "%" , 1, 'C', 0, 0, '', '', true);
    ...
    $pdf->SetFillColor(255); $pdf->SetTextColor($txBlack);
    $pdf->MultiCell( $wCol2 , 5, $Obt_8_19 . "%" , 1, 'C', 0, 0, '', '', true);
