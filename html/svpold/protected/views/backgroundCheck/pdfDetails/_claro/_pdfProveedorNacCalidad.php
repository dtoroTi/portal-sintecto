<?php
    ...
    $pdf->SetFillColor(220);
    $pdf->SetTextColor(0);
    $pdf->MultiCell(120, 0, "5. Certificación RUC" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, $XMLQuestionResult['certification_5'] , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220);
    $pdf->SetTextColor(0);
    $pdf->MultiCell(120, 0, "6. Certificación Basc" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, $XMLQuestionResult['certification_6'] , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220);
    $pdf->SetTextColor(0);
    $pdf->MultiCell(120, 0, "7. Certificación ISO 28000" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, $XMLQuestionResult['certification_7'] , 1, 'C', 0, 1, '', '', true);
    
    $pdf->SetFillColor(220);
    $pdf->SetTextColor(0);
    $pdf->MultiCell(120, 0, "8. Certificación OEA" , 1, 'L', 1, 0, '', '', true);
    $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, $XMLQuestionResult['certification_8'] , 1, 'C', 0, 1, '', '', true);
    
    $ansComments = $backgroundCheck->getVerificationSection(63)->comments;
    $pdf->SetFont('Arial', 'B', 9);
    $pdf->Cell('', '', '', '', 1, 'L');
