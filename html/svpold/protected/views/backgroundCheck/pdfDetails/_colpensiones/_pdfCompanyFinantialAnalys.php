...
if ($backgroundCheck->getVerificationSection(VerificationSectionType::DETAIL_COMPANY_FINANTIAL_ANALYS)->percentCompleted >=100 ) {
    ...
    $indicadores = array(
        ...
        1 =>'fondoLiquidez',
        2 =>'razonCorriente',
        2 =>'nivelDeEndeudamiento',
        3 =>'rentabilidadPatrimonioROA',
        4 =>'rentabilidadPatrimonioROE',
        5 =>'quebrantoPatrimonial',
    );
    ...
    // echo $indicador;
    $indicador_0 = "$". $indicador. "_0";
    $indicador_1 = "$". $indicador. "_1";
    echo (string)$indicador_0 . "<br>";
    $pdf->MultiCell(80, 0, "Razón Corriente" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, $indicador_0 , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, $indicador_1 , 1, 'R', 1, 1, '', '', true);
    //$pdf->MultiCell(45, 0, number_format($indicador_0, 2, '.', ''). " veces\n" , 1, 'R', 1, 0, '', '', true);
    ...
    */
    ...
    $pdf->MultiCell(45, 0, number_format($nivelDeEndeudamiento_0 * 100, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($nivelDeEndeudamiento_1 * 100, 2, '.', ''). "%" , 1, 'R', 1, 1, '', '', true);
    ...
    $pdf->SetFillColor(150,150,150); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(170, 0, "Indicadores Infraestructura" , 1, 'L', 1, 1, '', '', true);
    
    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(80, 0, "Quebranto Patrimonial" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($quebrantoPatrimonial_0, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($quebrantoPatrimonial_1, 2, '.', ''). "%" , 1, 'R', 1, 1, '', '', true);
