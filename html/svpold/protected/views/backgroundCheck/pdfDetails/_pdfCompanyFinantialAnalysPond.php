<?php
    ...
    $pdf->SetFillColor(0,66,109); $pdf->SetTextColor(255,255,255);
    $pdf->SetFont('Arial', '', 9);
    $pdf->MultiCell(50, 0, "INDICES FINANCIEROS " , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, $sectionCompanyFinantialAnalys->dateLastBalanceSheet , 1, 'C', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, $sectionCompanyFinantialAnalys->dateLastBalanceSheet_1 , 1, 'C', 1, 0, '', '', true);
    $pdf->MultiCell(30, 0, "Puntaje" , 1, 'C', 1, 1, '', '', true);
    $pdf->SetFillColor(150,150,150); $pdf->SetTextColor(0,0,0);
    
    $pdf->MultiCell(170, 0, "Indicadores de Liquidez" , 1, 'L', 1, 1, '', '', true);
    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, "Razón Corriente" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($razonCorriente_0, 2, '.', ''). " veces\n" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($razonCorriente_1, 2, '.', ''). " veces\n" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(30, 0,  $valRazonCorriente , 1, 'R', 1, 1, '', '', true);
    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    
    $pdf->MultiCell(50, 0, "Prueba Ácida" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($pruebaAcida_0, 2, '.', ''). " veces\n" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($pruebaAcida_1, 2, '.', ''). " veces\n" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(30, 0,  $valPruebaAcida , 1, 'R', 1, 1, '', '', true);
    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    
    $pdf->MultiCell(50, 0, "Capital de Trabajo" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, "$ " . number_format( $capitalDeTrabajo_0, 2, ',', '.') , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, "$ " . number_format( $capitalDeTrabajo_1, 2, ',', '.') , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(30, 0,  $valCapitalDeTrabajo , 1, 'R', 1, 1, '', '', true);
    $pdf->SetFillColor(150,150,150); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(170, 0, "Indicadores de Endeudamiento" , 1, 'L', 1, 1, '', '', true);
    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, "Nivel de Endeudamiento" , 1, 'L', 1, 0, '', '', true);
    ...
    $pdf->MultiCell(30, 0,  $valNivelDeEndeudamiento , 1, 'R', 1, 1, '', '', true);
    
    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, "Endeudamiento Financiero" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($endeudamientoFinanciero_0, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($endeudamientoFinanciero_1, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(30, 0,  $valEndeudamientoFinanciero , 1, 'R', 1, 1, '', '', true);

    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, "Apalancamiento Corto Plazo" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($apalancamientoCortoPlazo_0, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($apalancamientoCortoPlazo_1, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(30, 0,  $valApalancamientoCortoPlazo , 1, 'R', 1, 1, '', '', true);

    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, "Apalancamiento Largo Plazo" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($apalancamientoLargoPlazo_0, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($apalancamientoLargoPlazo_1, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(30, 0,  $valApalancamientoLargoPlazo , 1, 'R', 1, 1, '', '', true);
    
    $pdf->SetFillColor(150,150,150); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(170, 0, "Indicadores Rentabilidad" , 1, 'L', 1, 1, '', '', true);
    
    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, "Rentabilidad Operativa Activo (ROA)" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($rentabilidadPatrimonioROA_0, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($rentabilidadPatrimonioROA_1, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(30, 0,   $valRentabilidadPatrimonioROA , 1, 'R', 1, 1, '', '', true);
    
    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, "Rentabilidad Patrimonio (ROE)" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($rentabilidadPatrimonioROE_0, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($rentabilidadPatrimonioROE_1, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(30, 0,   $valRentabilidadPatrimonioROE , 1, 'R', 1, 1, '', '', true);
    
    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, "Margen Neto Utilidad" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($rentabilidadPatrimonioROE_0, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($rentabilidadPatrimonioROE_1, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(30, 0,   $valRentabilidadPatrimonioROE , 1, 'R', 1, 1, '', '', true);
    
    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, "Margen EBITDA" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($margenEBITDA_0, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($margenEBITDA_1, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(30, 0,  pondCalc('', $valMargenEBITDA, 2 ) , 1, 'R', 1, 1, '', '', true);
    
    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, "Cobertura Gastos Financieros" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($coberturaGastosFinancieros_0, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($coberturaGastosFinancieros_1, 2, '.', ''). "%" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(30, 0,  pondCalc('', $valCoberturaGastosFinancieros, 2 ) , 1, 'R', 1, 1, '', '', true);

    $pdf->SetFillColor(150,150,150); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(170, 0, "Indicadores Actividad" , 1, 'L', 1, 1, '', '', true);

    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, "Endeudamiento/Ventas" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($margenNetoUtilidad_0, 2, '.', ''). " veces\n" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($margenNetoUtilidad_1, 2, '.', ''). " veces\n" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(30, 0,   $valMargenNetoUtilidad , 1, 'R', 1, 1, '', '', true);
    
    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, "Cobertura de Gastos No Oper." , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($coberturadeGastosNoOperacionales_0, 2, '.', ''). " veces\n" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($coberturadeGastosNoOperacionales_1, 2, '.', ''). " veces\n" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(30, 0,   $valCoberturadeGastosNoOperacionales , 1, 'R', 1, 1, '', '', true);
    
    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, "Quebranto Patrimonial" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($quebrantoPatrimonial_0, 2, '.', ''). " veces\n" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($quebrantoPatrimonial_1, 2, '.', ''). " veces\n" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(30, 0,   $valQuebrantoPatrimonial , 1, 'R', 1, 1, '', '', true);
    
    $pdf->SetFillColor(255,255,255); $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(50, 0, "Fondo de Liquidez" , 1, 'L', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($fondoLiquidez_0, 2, '.', ''). " veces\n" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(45, 0, number_format($fondoLiquidez_1, 2, '.', ''). " veces\n" , 1, 'R', 1, 0, '', '', true);
    $pdf->MultiCell(30, 0,   $valFondoLiquidez , 1, 'R', 1, 1, '', '', true);
