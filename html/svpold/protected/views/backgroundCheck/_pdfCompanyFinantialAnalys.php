...
if (isset($sectionCompanyFinantialAnalys)){
    ...
    $apalancamientoCortoPlazo_0 = divideNumberss($pasivoCorriente_0, $pasivo_0);
    $apalancamientoCortoPlazo_1 = divideNumberss($pasivoCorriente_1, $pasivo_1);
    $apalancamientoLargoPlazo_0 = divideNumberss($pasivoNoCorriente_0, $pasivo_0) * 100;
    $apalancamientoLargoPlazo_1 = divideNumberss($pasivoNoCorriente_1, $pasivo_1) * 100;
...
// VISTA PDF Vanti
if ($backgroundCheck->customerId == 502){
    ...
    if ($backgroundCheck->getVerificationSection(VerificationSectionType::DETAIL_COMPANY_FINANTIAL_ANALYS)->percentCompleted >= 100) {
        ...
        if ($backgroundCheck->customerId == 648){
