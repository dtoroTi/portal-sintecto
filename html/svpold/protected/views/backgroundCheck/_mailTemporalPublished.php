<html>
    ...
    <body>
        ...
        <p>El estudio solicitado por usted con referencia  
            [<b><?php echo CHtml::encode($backgroundCheck->code) ?></b>], tiene un reporte preliminar publicado.
    </p>
    <p> Ya puede acceder al portal y descargar el informe Preliminar. Por favor tenga en cuenta que aún no ha sido finalizado el estudio.</p>
    <br/>
