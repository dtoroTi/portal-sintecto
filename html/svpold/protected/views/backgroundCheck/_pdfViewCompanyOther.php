...
if($shareholdersSection != null)
{
    ...
    $pdf->MultiCell(170, 0, "VALIDACIÓN LISTAS RESTRICTIVAS-", 0, 'C', 1, 1, '', '', true);
    ...
    foreach ($shareholdersSection->detailShareholder as $shareholder) {
        ...
        $pdf->Cell(45, '', $shareholder->firstName . " " . $shareholder->lastName , 1, 0, 'L', 1);
    ...
    $pdf->MultiCell(170, 0, "Convención a Socios y Representantes Legales" , 0, 'L', 1, 1, '', '', true);
    $pdf->SetFont('Arial', '', 7);
...
if ($backgroundCheck->getVerificationSection(VerificationSectionType::DETAIL_COMPANY_FINANTIAL_ANALYS) != null) {
    include(Yii::app()->basePath . '/views/backgroundCheck/_pdfCompanyFinantialAnalys.php');
}
