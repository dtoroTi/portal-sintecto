...
<div class="form wide">
    ...
    if(Yii::app()->user->isIt || Yii::app()->user->isDescription){
        $value=false;
    }else{
        $value=true;
    }
    ...
    <!--<div class="row">
        <label style= "width:150pt;"><a href="/files/ListadoPlantilla.pdf" target="_blank">LISTADO OPCIONES PLANTILLA</a></label>
    </div>
    <br>-->
