...
foreach ($sectionImport as $result ){
...
Yii::app()->request->sendFile("Sec_Importaciones_Coface" . date("Ymd_His") . ".csv", "\xEF\xBB\xBF" . stream_get_contents($fp), "text/csv", true);
fclose($fp);
