...
<div class="form wide">
    ...
    <?php if ($isActive): ?>
        ...
        <fieldset>
            ...
            <div class="row">
                    <?php echo $form->labelEx($query, 'sdnTypeId'); ?>
                    <?php
                    echo CHtml::activeDropDownList(//
                            $query, //
                            'sdnTypeId', //
                            CHtml::listData(SdnType::model()->findAll(), 'id', 'name'), //
                            array('prompt' => '...',));
                    ?>
                    <?php echo $form->error($query, 'sdnTypeId'); ?>
        ...
        <fieldset>
            <legend>Buesqueda en Archivo separado por [TAB]</legend>    	
            <div class="row">
                <?php echo $form->labelEx($query, 'uploadedFile'); ?>
                <?php echo $form->fileField($query, 'uploadedFile'); ?>
                <?php echo $form->error($query, 'uploadedFile'); ?>
                <p class="hint">
                    * El archivo debe tener tres columnas separadas por TAB (Nombres Apellidos ID) por cada línea. 
                </p>
                <p class="hint">
                    * El nombre del archivo debe terminar en .txt 
                </p>
                <p class="hint">
                    * El archivo puede ser creado en Excel de tres columnas que se guarda como txt separado por TAB
                </p>
            </div>
        </fieldset>
