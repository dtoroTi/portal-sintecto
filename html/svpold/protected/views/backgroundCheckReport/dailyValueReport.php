...
$style = array(
    ...
    'tdPercent' => array(
        0 => 'border: 1pt solid #00518A;text-align: right;',
        -1 => 'border: 1pt solid #00518A;text-align: right;background-color:#FD7135;',
        1 => 'border: 1pt solid #00518A;text-align: right; background-color:#66BD7D;',
    )
);
?>
<html>
    ...
    <body style="font:normal 10pt Arial,Helvetica,sans-serif;">
        ...
        <?= $this->renderInternal(Yii::app()->basePath . '/views/backgroundCheckReport/customersPricesReport.php', array('report' => $report, 'style' => $style)) ?>
