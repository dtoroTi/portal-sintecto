...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'typeDoc'); ?>
		<?php echo $form->textField($model,'typeDoc',array('size'=>5,'maxlength'=>5)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'cityService'); ?>
	...
	<div class="row">
		<?php echo $form->label($model,'serviceProvidedId'); ?>
		<?php echo $form->textField($model,'serviceProvidedId'); ?>
	</div>
