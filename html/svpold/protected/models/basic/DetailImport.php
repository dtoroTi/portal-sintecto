...
/**
 * This is the model class for table "{{DetailImport}}".
 *
 * The followings are the available columns in table '{{DetailImport}}':
 * @property integer $id
 ...
 */
class DetailImport extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('Ruc, Import, CountryCode, CountryName, CountryList, AsOfDate, Amount, Currency', 'length', 'max' => 255),
            array('Percentage', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, verificationSectionId, verificationResultId, Ruc, Import, CountryCode, CountryName, CountryList, AsOfDate, Amount, Currency, Percentage','safe', 'on' => 'search'),
        );
    }
     ...
     * @return DetailImport the static model class
     */
