...
class GridViewFilter {
    ...
    static public function getClearButton($route,$actionParams=array()){
        return CHtml::link('Quitar Filtros', Yii::app()->createUrl($route, array_merge($actionParams,array('clearFilter' => 1))));
    }
