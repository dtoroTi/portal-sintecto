    ...
    <body>
        <form method="POST" action="formularioCompliance" class="">
            ...
            <div>
                <div class="card" >
                    <div class="card-body">
                        <label><center><b>ESTUDIOS EN ESTE PERIODO</b></center></label>
                        <div class="row g-2">                 
                            <div class="col-lg-2">
                                <canvas id="Graficodoughnutcliente" width="400" height="400" ></canvas><br><br> 
                                <center><label form="" data-toggle="modal" data-target="#staticBackdropC" class="secc_estudiosperiodos"><b>CLIENTE ></b></label></center>
                            </div>

                            <div class="col-lg-2">
                                <canvas id="Graficodoughnutproveedores" width="400" height="400"></canvas><br><br> 
                                <center><label form=""  form="" data-toggle="modal" data-target="#staticBackdropP" class="secc_estudiosperiodos"><b>PROVEEDORES ></b></label></center>
                            </div>

                            <div class="col-lg-2">
                                <canvas id="Graficodoughnutcolaboradores" width="400" height="400"></canvas><br><br>  
                            ...
                            <div class="col-lg-2">
                                <canvas id="Graficodoughnutotros" width="400" height="400"></canvas><br><br>   
                                <center>
                                    <label form="Otros" data-toggle="modal" data-target="#staticBackdropO" class="secc_estudiosperiodos" ><b>OTROS ></b></label>
                                </center>
                            </div>
                                  ...
                                  <div class="card-body">
                                        ...
                                        <div class="row g-2"  style="padding-left: 15px;">
                                            ...
                                            <div style="padding-left: 8px;">
                                                ...
                                                <!--<input type="submit" class="btn btn-primary btn-sm" onclick="redirigir()" value="BUSCAR">-->
                                            </div>
                                        </div>   
                                  </div>
                                </div>
...
<!-- VENTANA MODAL CLIENTE (ESTUDIOS EN ESTE PERIODO) -->
    <div class="modal fade" id="staticBackdropC" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">ESTUDIOS CLIENTES</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <table id="cliente" border="1" class="table-striped"> 
                        <thead class="table-primary"> 
                            <th>Ref.</th> 
                            <th>Nombre</th> 
                            <th>Estado</th> 
...
<!-- VENTANA MODAL PROVEEDORES (ESTUDIOS EN ESTE PERIODO) -->
    <div class="modal fade" id="staticBackdropP" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">ESTUDIOS PROVEEDORES</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <table id="provedores" border="1" class="table-striped"> 
                        <thead class="table-primary"> 
                            <th>Ref.</th> 
                            <th>Nombre</th> 
                            <th>Estado</th> 
...
<!-- VENTANA MODAL OTROS (ESTUDIOS EN ESTE PERIODO) -->
    <div class="modal fade" id="staticBackdropO" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">ESTUDIOS OTROS</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <table id="otros" border="1" class="table-striped"> 
                        <thead class="table-primary"> 
                            <th>Ref.</th> 
                            <th>Nombre</th> 
                            <th>Estado</th> 
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table id="DetalleSecciones" border="1" class="table-striped">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <?php 
                                        ...
                                        /*echo CHtml::button('Refrescar',    
                                            array(
                                            'id' => 'export-button',
                                            'class' => 'btn btn-primary btn-sm',   
                                            'onclick' =>'ans=confirm("Está seguro recargar las fuentes caidas de: ' . $datos['numberId']. '?"); if (ans) {document.location.href="/site/refresh?valor='.$datos['tusdatosId'].'&doc='.$datos['numberId'].'&type='.$datos['tipe_Id'].'";}'));*/

                                        /*echo CHtml::button('Refrescar', array(
                                            'id' => 'export-button',
                                            'class' => 'btn btn-primary btn-sm',   
                                            'onClick' => "window.open('".Yii::app()->controller->createUrl('/site/refresh', array(
                                                   'valor' => $datos['tusdatosId'],
                                                   'doc' => $datos['numberId'],
                                                   'type' => $datos['tipe_Id']
                                                )) . "','_blank');"
...
function mostar_datos(){
    ...
    context: document.body
        ...
        if(resp.length>0){
            var data = resp;
            for(var i=0; i<data.length; i++){
                if(data[i]["typeStudy"]=="Clientes"){
                    var tblRow = "<tr>" + "<td>" + data[i]["code"]+ "</td>" + 
                        "<td>" + data[i]["nombre"] + "</td>" + 
                        "<td>" + data[i]["TipoEstado"] + "</td>"+"</tr>" 
                        $(tblRow).appendTo("#cliente tbody");  
                }
                if(data[i]["typeStudy"]=="Proveedores"){
                    var tblRow = "<tr>" + "<td>" + data[i]["code"]+ "</td>" + 
                        "<td>" + data[i]["nombre"] + "</td>" + 
                        "<td>" + data[i]["TipoEstado"] + "</td>"+"</tr>" 
                        $(tblRow).appendTo("#provedores tbody");  
                }
                ...
                if(data[i]["typeStudy"]=="Otros"){
                    var tblRow = "<tr>" + "<td>" + data[i]["code"]+ "</td>" + 
                        "<td>" + data[i]["nombre"] + "</td>" + 
                        "<td>" + data[i]["TipoEstado"] + "</td>"+"</tr>" 
                        $(tblRow).appendTo("#otros tbody");  
                }
            }
        }
    })
...
$("#sec_notificaciones").on("click", function(ev){
    ...
    $.ajax({
    type:'POST',
    url: "/site/detailNotifications.html",
    dataType: "json",
    context: document.body
    }).done(function(resp) {
        $('#notificaciones > tbody').empty();
        $( this ).addClass( "DetailNotifications" );
        if(resp.length>0){
            var data = resp;
...
function crear_grafico(){
    $.ajax({
        ...
        if(resp.length>0){
            ...
            var textInside = '';
            CrearGrafico(titulo, cantidad, colores, 'doughnut', ' ','Graficodoughnutcliente', textInside, abierto, cerrado);
        }
        //pinta el grafico de Proveedores
        if(resp.length>0){
            var colores=[];
            var titulo =[];
            var cantidad = [];
            ...
            var textInside = '';
            CrearGrafico(titulo, cantidad, colores, 'doughnut', ' ','Graficodoughnutproveedores', textInside, abierto, cerrado);
        }
        ...
        if(resp.length>0){
            ...
            var textInside = '';
            CrearGrafico(titulo, cantidad, colores, 'doughnut', ' ','Graficodoughnutotros', textInside, abierto, cerrado);
        }
