...
class PasswordStrength extends CValidator {
  ...
  protected function validateAttribute($object, $attribute) {
    ...
    if (!($this->allowEmpty && strlen($value)==0) && !preg_match($pattern, $value)) {
      $this->addError($object, $attribute, 'La palabra clave es muy débil, por favor utilice una combinación de números, caracteres especiales, letras mayusculas y minúsculas de más de 8 caracters ');
    }
  }
